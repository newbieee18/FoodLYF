...
<div class="row" style ="max-width: 100%;">
        <div class="col-sm-3 menu" style ="text-align: center;">
            <ul>
               <a href="customers.php" style="text-decoration: none; font-family: Cooper Black;"><li style="background-color: #32E6C2;">Customers</li></a>
    ...
    <div class="col-md-9" style="">
        <h2 style="font-family: Arial;">Customers</h2>
  ...
  <table>
    ...
    <tr>
      <?php while($row = mysqli_fetch_assoc($res)){
        echo 
        "
          <td><input type='text' name='username' value='".$row['phone']."' style='text-align: center; background: transparent; border: none;' disabled></td>
          ...
          <td><input type='text' name='address' value='".$row['address']."' style='text-align: center; background: transparent; border: none;' disabled></td>
          <td><center>          
          <a href='javascript:;' class='editAttr' data-toggle='modal' data-target='#edit_customer' data-id='".$row['id']."' data-phone='".$row['phone']."' data-fullname='".$row['fullname']."' data-email='".$row['email']."' data-address='".$row['address']."' style='background-color: #24a0ed; border-radius: 5px; text-decoration: none; font-family: Times New Roman; font-weight: bold; color: white; text-align: center; width: 90px; display: block;'>EDIT</a>
          <a href='delete_users.php?delete=".$row['id']."' style='background-color: #C70000; border-radius: 5px; text-decoration: none; font-family: Times New Roman; font-weight: bold; color: white; text-align: center; width: 90px; display: block;' role='button'>DELETE</a></center>
          </td>"; 
      ?>
    </tr>
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                     <form method="post">  
                      ...
                      <label>Address</label> 
                      <input type="text" name="address" value='' id="address" class="form-control" /> <br />
...
if(isset($_POST['submit'])){
    ...
    $sql = mysqli_query($db,"update users set phone='$phone', fullname='$fullname', email='$email', address='$address' where id='$id'");
